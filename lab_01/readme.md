...
2. Utwórz projekt testowy Unity i skonfiguruj narzędzie Git do pracy z tym projektem. Stwórz zdalne repozytorium (GitHub, Bitbucket) i wypchnij do niego lokalne repozytorium. Pamiętaj o przygotowaniu odpowiedniego pliku .gitignore.
...
7. Jeżeli uważasz, że wiedza z akresu języka C# wymaga odświeżenia to warto ją sobie odświeżyć i może warto zacząć od [Wstęp do programowania w C#](c_sharp_wer2_0.pdf). W trakcie zajeć z czasem programowania w tym języku będzie coraz więcej i poza omawianiem samego API Unity lekcji samego języka C# się nie przewiduje.